...
#Commenr below 4 lines to remove dollar conversion of rupees
m_df['Open'] = round(m_df['Open']/m_df['USDINR'],2)
m_df['Close'] = round(m_df['Close']/m_df['USDINR'],2)
m_df['High'] = round(m_df['High']/m_df['USDINR'],2)
m_df['Low'] = round(m_df['Low']/m_df['USDINR'],2)
...
agg_df.to_csv("./prepare_data/data/stock_analysis_V3.csv")
